  ...
  return (
    <div className="flex justify-start mb-6 animate-fade-in">
      <div className="flex max-w-[85%] lg:max-w-[70%] gap-3">
        {/* AI Avatar */}
        <div className="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center bg-card border border-border hover:border-primary/50">
        ...
        <div className="bg-card border border-border rounded-2xl rounded-tl-md shadow-sm hover:shadow-md hover:border-primary/50 px-4 py-3">
